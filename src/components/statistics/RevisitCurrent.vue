<template>
  <div class="q-pa-md">
    <div class="row col-12">
      ...
      <div class="col-9 q-pl-sm q-mb-sm">
        <q-card
    ...
    <div class="row col-12">
      <div class="col-12 q-pr-sm q-mt-sm row">
        <q-card class="q-pa-md full-width" style="align-content: center">
          <!-- 여기 연령/성별별 통계로 바꾸기 -->
          <RevisitRateByAgeGender class="full-width" />
        </q-card>
      </div>
    </div>
  </div>
...
import ReservationCntThisMonth from "./ReservationCntThisMonth.vue";
import RevisitRateByAgeGender from "./RevisitRateByAgeGender.vue";
import RevisitRate from "./RevisitRate.vue";
