<template>
    <q-page class="q-pa-xl">
      <section class="q-mb-xl">
        <div class="text-h4">고객 페이지 입니다 !!!!! </div>
        ...
        <p class="text-subtitle1">Subtitle 2</p>
        <p class="text-body1">
      ...
      <section>
        ...
        <q-separator class="q-my-md" />
        <p class="text-weight-thin text-right">Lorem Ipsum is Simply dummy</p>
        <p class="text-weight-medium text-center">Lorem Ipsum is Simply dummy</p>
        <p class="text-weight-bold text-strike">Lorem Ipsum is Simply dummy</p>
      </section>
      <section>
